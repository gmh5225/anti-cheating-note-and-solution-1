...
sc stop "LMS"
sc config "EvtEng" start= disabled
sc stop "EvtEng"
sc config "RegSrvc" start= disabled
sc stop "RegSrvc"
sc config "ZeroConfigService" start= disabled
sc stop "ZeroConfigService"
